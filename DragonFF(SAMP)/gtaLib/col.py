...
class coll:
    ...
    def __write_col(self, model):
        ...
        custom_header = bytes.fromhex("FF F2 53 02 FD 00 00 00 FF FF 03 18 43 4F 4C 33 90 00 00 00 73 61 6D 70 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 43 45 44 32")
        header_size = 40
        header = [
        ...
        return pack("4sI22sH", *header) + custom_header + data
