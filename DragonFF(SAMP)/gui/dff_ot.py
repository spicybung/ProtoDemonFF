    ...
    def add_extension_and_collision_data(file_path):
        try:
            ...
            with open(file_path, "r+b") as dff_file:
                ...
                # Create the Extension section at the end of the file
                extension_values = b'\xFF\xF2\x53\x02\x40\x21\x00\x00\x73\x61\x6D\x70\x43\x4F\x4C\x33'
                dff_file.write(extension_values)
                ...
                collision_values = b'\xFF\xF2\x53\x02\x40\x21\x00\x00\x73\x61\x6D\x70\x43\x4F\x4C\x33'  # Replace with collision data values
